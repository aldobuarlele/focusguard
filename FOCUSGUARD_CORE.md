...
- **[COMPLETED] Phase 1: OS Foundation & Native Bridge**
  - Setup React Native Bare Workflow & Kotlin Services.
  - Komunikasi langsung OS untuk trigger Overlay merah tanpa delay.

- **[COMPLETED] Phase 2: Data Persistence & UI Setup**
  - Setup skema database SQLite lokal (Native Android).
